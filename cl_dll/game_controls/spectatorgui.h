...
protected:
	...
	void UpdateScores(); //LAWYER:  New function for updating team scores
...
//	virtual void OnCommand( const char *command );
	...
	int	currenttarget; //TGB: who we are currently observing
	int currenthealth; //TGB: and his health
