	...
	case HUDTYPE_CAROUSEL:
		{
			...
			else
			{
				...
				while ( 1 )
				{
					...
					{
						//TGBMERGENOTE: broken beyond belief in the merge, this shouldn't even be in this location
						//TGB: although we can select this weapon in ZM, colour it different anyway
