...
void CHudHealth::OnThink()
{
	...
	if (local)
	{
		//TGB: wait, true when team == 3? don't think we should show health when we're ZM
		visible = (local->GetTeamNumber() == 3) ? false : true;
	}
	...
	//TGB: this needed a 'local'-check as well
	if ( local )
	{
		// Never below zero
