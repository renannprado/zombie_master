...
public:
	...
	virtual int BloodColor() { return BLOOD_COLOR_RED; }; // qck edit
...
{ 
	//TGB: prevent bad sequence numbers which apparently can cause model-related crashes, which we've had
	if (m_nSequence < 0)
		m_nSequence = 0;
