...
//================================================================================================================
// The overlay actually works with the above HDR buffers, but we really shouldn't touch those. I made these for us
// We can make as many more as we'd like now.
//================================================================================================================
static CTextureReference s_pBlurXBuffer;

ITexture *GetBlurXBuffer( void )
{

	if( !s_pBlurXBuffer )
	{
		s_pBlurXBuffer.InitNamedRenderTarget("_rt_blur_x", 512, 512, RT_SIZE_DEFAULT, IMAGE_FORMAT_ARGB8888, MATERIAL_RT_DEPTH_NONE);
		Assert( !IsErrorTexture( s_pBlurXBuffer ) );
		DevMsg("Working on X\n");
	}

	return s_pBlurXBuffer;
}

static CTextureReference s_pBlurYBuffer;
