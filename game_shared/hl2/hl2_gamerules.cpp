...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	{
		BaseClass::Think();
		/* // TGBMERGENOTE: Errors and we don't use it anyway: commented
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		//TGB: putting this here too :: LAWYER:  Extra ammo types for ZM
		def.AddAmmoType("Molotov",			DMG_BURN,					TRACER_NONE,			0,			0,			3,			0,							0);
		def.AddAmmoType("Revolver",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			24,			BULLET_IMPULSE(800, 5000),	0 );
	}
