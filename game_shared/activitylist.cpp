...
// NOTE: If CStrinlinearistry allowed storing arbitrary data, we could just use that.
...
/*	REGISTER_SHARED_ACTIVITY ( ACT_MOLOTOV_FIRE1 );
	REGISTER_SHARED_ACTIVITY ( ACT_MOLOTOV_FIRE2 );
	REGISTER_SHARED_ACTIVITY ( ACT_MOLOTOV_FIRE3 );
	REGISTER_SHARED_ACTIVITY ( ACT_MOLOTOV_IGNITE );*/
