...
// Ammo Definitions
	...
	virtual int DefaultFOV( void ) { return 75; } //qck: FOV was set to 90 here. Should be 75. //TGB: new SDK says 90 though
	...
	virtual const CViewVectors* GetZMViewVectors() const;
...
// Functions to verify the single/multiplayer status of a game
	...
	bool m_bFirstTrigger; //LAWYER:  A hacky way of stopping the first round restart
...
// Whether props that are on fire should get a DLIGHT.
	...
	virtual bool CanEntityBeUsePushed( CBaseEntity *pEnt ) { /*return true;*/ return false; /*tGB: we use use for other things*/ }

#endif

	//LAWYER STUFF
	virtual void WorldReset( void ){}
	virtual void EndRound( void ){}
	virtual void FinishingRound( void ){}
