...
extern ConVar zm_votesneeded; //LAWYER:  For voting a round restart
//=========================================================
...
//	float m_flRoundRestart; //LAWYER: a time based variable for controlling round restarts
	...
	//TGB: tells the gamerules a player just spawned (most likely into the observer team), if there's no ZM we should RR
	virtual void PlayerSpawning( void );
...
protected:
	...
	float m_iRoundsCompleted; //LAWYER:  Round counter.
