...
public:
...
#ifdef CLIENT_DLL
	//TGB: tooltip virtual override
	virtual const char*		GetZMTooltip()	{ return "A human weapon."; }
#endif
	...
	//TGB: get the damage from hl2mpweaponinfo, ie. the weapon script
	float GetPlayerDamage() { return GetHL2MPWpnData().m_iPlayerDamage; }
