...
//	AddViewKick();
	...
	if ( pHitEntity != NULL )
	{
		...
		//TGB: we want blood splats to happen on the client
//#ifndef CLIENT_DLL
...
void CBaseHL2MPBludgeonWeapon::Swing( int bIsSecondary )
{
	...
	//TGB: our melee weapons are more prominent and need hitbox accuracy, therefore: (MASK_SHOT_HULL|CONTENTS_HITBOX)
	UTIL_TraceLine( swingStart, swingEnd, (MASK_SHOT_HULL|CONTENTS_HITBOX), pOwner, COLLISION_GROUP_NONE, &traceHit );
