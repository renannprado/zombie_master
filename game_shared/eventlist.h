...
typedef enum
{
	...
	AE_NPC_MUZZLEFLASH,		// Muzzle flash from weapons held by NPCs
							// TGB
	AE_ZM_MELEEHIT,			// ZM Melee weapon hit
	AE_ZM_REVOLVERSHOOT,	//LAWYER:  Revolvering
	AE_ZM_BEAMON,			// Flashlight goes on
	AE_ZM_BEAMOFF,			// Flashlight goes off
	AE_ZM_LIGHTERFLAME,		// molotov flame toggle
	AE_ZM_CLOTHFLAME,		// molotov cloth flame ignition
