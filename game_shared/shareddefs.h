...
#define HIDEHUD_TOOLTIP				( 1<<11 )	// ZM: Hide tooltip
...
*/
//TGB ALTERED VALUES FOR HIGHER FALL DAMAGE
//these were rather high, and I found out mp_falldamage turns on the above values, with that cvar off it's fixed to 10

#define PLAYER_FATAL_FALL_SPEED		900.0f
#define PLAYER_MAX_SAFE_FALL_SPEED	500.0f // approx 20 feet sqrt( 2 * gravity * 20 * 12 )
#define PLAYER_LAND_ON_FLOATING_OBJECT	173 // Can fall another 173 in/sec without getting hurt
#define PLAYER_MIN_BOUNCE_SPEED		150
#define PLAYER_FALL_PUNCH_THRESHOLD 300.0f // won't punch player's screen/make scrape noise unless player falling at least this fast - at least a 76" fall (sqrt( 2 * g * 76))
...
//TGB INCREASED FOR HIGHER FALL DAMAGE
#define DAMAGE_FOR_FALL_SPEED		150.0f / ( PLAYER_FATAL_FALL_SPEED - PLAYER_MAX_SAFE_FALL_SPEED ) // damage per unit per second.
