...
int ITEM_GiveAmmo( CBasePlayer *pPlayer, float flCount, const char *pszAmmoName, bool bSuppressSound = false )
{
	...
	//TGB: ammo space requirements moved to BaseCombatCharacter::GiveAmmo, for nice "can't pickup" icon
...
// ========================================================================
//	>> CItem_BoxRevolverRounds
// ========================================================================
class CItem_BoxRevolverRounds : public CItem
{
public:
	DECLARE_CLASS( CItem_BoxRevolverRounds, CItem );
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo( pPlayer, SIZE_AMMO_REVOLVER, "Revolver"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
LINK_ENTITY_TO_CLASS(item_ammo_revolver, CItem_BoxRevolverRounds);
...
const char *CItem_AmmoCrate::m_lpzModelNames[NUM_AMMO_CRATE_TYPES] =
{
	...
	"models/items/ammocrate_357.mdl",		// Revolver
