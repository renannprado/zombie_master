...
public:
	...
	CUtlVector<CBaseEntity *>	m_BansheeList;
	CUtlVector<CBaseEntity *>	m_ZombieSelected;
	CUtlVector<CBaseEntity *>	m_ZombieSpawns;
	CUtlVector<CBaseEntity *>	m_ZombieManipulates;
	CUtlVector<CBaseEntity *>	m_ZombieTraps;
	CUtlVector<CBaseEntity *>	m_ZombieAmbushPoints;
	CUtlVector<CBaseEntity *>	m_ZombieSpotCreateBlocker; //LAWYER:  That's a mouthful
	//qck: Global group register thing...heh
	//CUtlVector<CZombieGroup *>	m_ZombieGroups;
private:
...
public:
	...
	//TGB: a quick func for testing the ent list for NULL entities
	void TestEntities();
