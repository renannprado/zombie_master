...
void Pickup_ForcePlayerToDropThisObject( CBaseEntity *pTarget )
{
	...
	{
//		CBasePlayer *pPlayer = UTIL_GetLocalPlayer(); //LAWYER: This is causing a crash.  Needs a fix
//		pPlayer->ForceDropOfCarriedPhysObjects( pTarget ); //LAWYER:  Never force a drop until we work out how to fix this.
	}
}
