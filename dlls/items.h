...
#define SIZE_AMMO_SMG1				30 //LAWYER:  Reduced to the clip size
...
#define SIZE_AMMO_BUCKSHOT			8 //LAWYER:  Dropped to 8 from 12, due to clip mismatch
#define SIZE_AMMO_357				11 //LAWYER:  Pumped, because 6 is a really weird number
