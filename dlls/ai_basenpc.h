...
//TGB: for lagrecord, forward decl refused to work. hi I'm C++ linking I suck ass
...
public:
	...
	/*TGBOLDDEBUG*/
	//qck: Zombies need these
	int					GetZombieSpawnID() {return m_iOwner;}
	bool				ShouldSearchForRallyPoint() {return m_bShouldSearchForRallyPoint;}

	void				SetZombieSpawnID( int ID );
	void				SetRallySearch( bool search );
...
private:
	...
	//qck: Zombies need to know these three things.
	int					m_iOwner;
...
public:
	...
	Vector				m_vecLastGoalPosition; //qck: I'm not sure if there is a way to find this out provided to us. Quicker to just do this than look.
...
public:
	...
	//LAWYER:  Our very own move command!
...
/*TGBOLDDEBUG*/
	void			SearchOutRallyPoint();					//qck edit
...
/* TGBOLDDEBUG*/
	bool				m_bRallyPointSeek;			//qck edit
	//int					m_iHomeSpawn;		//qck edit
