...
ConVar sv_respawnrange		( "sv_respawnrange","1024", FCVAR_NOTIFY | FCVAR_REPLICATED, "Respawn range." ); //LAWYER:  Respawn range
...
void CBaseCombatWeapon::AttemptToMaterialize( void )
{
	...
	//LAWYER:  Respawning doesn't happen when items are being camped.
