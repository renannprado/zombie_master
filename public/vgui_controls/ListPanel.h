...
public:
	...
	//TGB: needed a switch for this, stupid how it's not in by default
			void SetAscending( bool toggle ) { m_bSortAscending = toggle; }
...
protected:
	...
	//TGBMERGENOTE: taken out by new source
	//MESSAGE_FUNC_INT( ResizeColumnToContents, "ResizeColumnToContents", column );
