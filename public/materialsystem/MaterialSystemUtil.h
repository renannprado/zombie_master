...
public:
	...
	void InitNamedRenderTarget( const char *pRTName, int w, int h, RenderTargetSizeMode_t sizeMode, ImageFormat fmt, MaterialRenderTargetDepth_t depth ); // qck edit- This lets us create named render targets CORRECTLY
