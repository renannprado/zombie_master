...
//
// $Header: /home/pimurho/cvs/zm_src_latest/sdkshaders/advanced/sdk_lightmappedgeneric_dx8.cpp,v 1.1 2006-06-01 16:02:47 tgb Exp $
// $NoKeywords: $
//=============================================================================//
...
BEGIN_VS_SHADER( SDK_LightmappedGeneric_DX8,
	...
	SHADER_INIT_PARAMS()
	{
		...
		if ( params[ENVMAP]->IsDefined() && IS_FLAG_SET( MATERIAL_VAR_NORMALMAPALPHAENVMAPMASK ) && !ShouldUseBumpmapping( params ) )
		{
