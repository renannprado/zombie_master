...
// Purpose: 
//
// $Header: /home/pimurho/cvs/zm_src_latest/sdkshaders/advanced/sdk_vertexlitgeneric.cpp,v 1.1 2006-06-01 16:02:47 tgb Exp $
// $NoKeywords: $
//=============================================================================//

#include "BaseVSShader.h"

DEFINE_FALLBACK_SHADER( SDK_VertexLitGeneric, SDK_VertexLitGeneric_DX9 )

BEGIN_VS_SHADER( SDK_VertexLitGeneric_DX9, 
				"Help for SDK_VertexLitGeneric_DX9" )
	BEGIN_SHADER_PARAMS
...
//		CLEAR_FLAGS( MATERIAL_VAR_BASEALPHAENVMAPMASK );
	...
	{	
		...
		if (g_pHardwareConfig->GetDXSupportLevel() < 90)
			return "SDK_VertexLitGeneric_DX8";
