...
// Purpose: 
//
// $Header: /home/pimurho/cvs/zm_src_latest/sdkshaders/advanced/sdk_vertexlitgeneric_dx8.cpp,v 1.1 2006-06-01 16:02:47 tgb Exp $
// $NoKeywords: $
//=============================================================================//
...
//			if (params[ENVMAP]->IsTexture())
	...
	inline const char *GetBumpedDiffusePixelShaderName( IMaterialVar **params )
	{
		static char const* s_pPixelShaders[] = 
		{
			"SDK_VertexLitGeneric_DiffBumpLightingOnly_Overbright2",
			"SDK_VertexLitGeneric_DiffBumpLightingOnly_Overbright2_Translucent",
			"SDK_VertexLitGeneric_DiffBumpTimesBase_Overbright2",
			"SDK_VertexLitGeneric_DiffBumpTimesBase_Overbright2_Translucent",
		};
...
*/
	...
	void DrawBumpedSelfIllumPass( IMaterialVar** params, IShaderDynamicAPI *pShaderAPI, IShaderShadow* pShaderShadow )
	{
		SHADOW_STATE
		{
			...
			sdk_vertexlitgeneric_selfillumonly_Static_Index vshIndex;
			pShaderShadow->SetVertexShader( "SDK_VertexLitGeneric_SelfIllumOnly", vshIndex.GetIndex() );

			pShaderShadow->SetPixelShader( "SDK_VertexLitGeneric_SelfIllumOnly" );
		}
		...
		DYNAMIC_STATE
		{
			...
			sdk_vertexlitgeneric_selfillumonly_Dynamic_Index vshIndex;
			vshIndex.SetFOG_TYPE( pShaderAPI->GetSceneFogMode() == MATERIAL_FOG_LINEAR_BELOW_FOG_Z );
			vshIndex.SetNUM_BONES( pShaderAPI->GetCurrentNumBones() );
			pShaderAPI->SetVertexShaderIndex( vshIndex.GetIndex() );
		}
